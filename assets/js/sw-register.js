  ...
  function autoUpdate(reg) {
    ...
    if (typeof MessageChannel !== 'undefined') {
      ...
      var skipWaitingOnce = function () {
        ...
        try { if (reg.waiting) reg.waiting.postMessage({ type: 'SKIP_WAITING' }); } catch (e) { /* intentionally ignored: optional fallback failure */ }
      };
      ...
      try { reg.waiting.postMessage({ type: 'SKIP_WAITING' }); } catch (e) { /* intentionally ignored: optional fallback failure */ }
    }
  }
