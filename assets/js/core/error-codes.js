/** core/error-codes.js - 對外一般錯誤碼 → 使用者提示 對照表 */
var ErrorCodes = (function(){
  ...
  function detailMessage(details){
    ...
    var first = details[0];
    var f = first.field ? first.field + ' ' : '';
    var c = FIELD_CODE_MSG[first.code] || first.code || '';
    return c ? (f + c) : '';
  }
  ...
  return { MESSAGES: M, FIELD_CODE_MSG: FIELD_CODE_MSG, codeOf: codeOf, messageFor: messageFor, messageForResponse: messageForResponse, detailMessage: detailMessage };
})();
if(typeof globalThis!=='undefined') globalThis.ErrorCodes = ErrorCodes;
if(typeof module!=='undefined' && module.exports) module.exports = ErrorCodes;
