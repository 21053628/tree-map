...
// 🔥 向後相容橋接：經典腳本消費端（api.js / auth.js / offline.js）仍經 globalThis 讀取；待 Phase 8 全部轉 ESM 後移除
try { if (typeof globalThis !== 'undefined') globalThis.ErrorCodes = ErrorCodes; } catch (e) {}